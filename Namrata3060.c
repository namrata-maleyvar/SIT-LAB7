 ...
 *
 *         double y1=add_3(double u1, double u2, double u3)
 *
 *    Simulink version           : 9.2 (R2018b) 24-May-2018
 *    C source code generated on : 07-Mar-2019 10:04:02
 *
...
#define S_FUNCTION_NAME  Namrata3060
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "add_3", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
